...
spi = spidev.SpiDev()
spi.open(0,0)
spi.max_speed_hz  = 1000000 #600000  spi.max_speed_hz
spi.lsbfirst=False
spi.mode=0b01
spi.bits_per_word = 8
...
while 1:
    ...
    #print("2", button_state_2)
        ...
        button_state_2 = line_2.get_value()  
        #print (button_state)
...
#            print (output[0],output[1],output[2])
            ...
            if output_2[0]==192 and output_2[1] == 0 and output_2[2] == 8 and output[0]==192 and output[1] == 0 and output[2]==8:
                #print ("ok4")
                ...
                if len(data_9ch_test)==2000:
                                    if len(data_9ch_test)==2000:
                                        ...
                                        df.to_excel("pieeg_datset.xlsx", index=False)
                                        print (df)
